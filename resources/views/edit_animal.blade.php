      ...
      @endif
        <form method="post" action="{{ route('animals.update', $animal->id) }}">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_id" value="{{ $animal->subcategory_id }}"/>

                <div class="form-group">
                        <label for="venduto">Venduto</label>
                        <input type="checkbox" name="venduto" class="form-control" value="1"/>
                    </div>
                    <div class="form-group">
                        <label for="venduto">Ritirato dal commercio</label>
                        <input type="checkbox" name="venduto" class="form-control" value="0"/>
                    </div>
